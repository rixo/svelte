...
import { a as stores$1 } from './app.9be19e51.js';
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "viewport svelte-ol2svg");
			toggle_class(div, "offset", ctx.checked);
			add_location(div, file, 226, 2, 5098);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(meta0, file, 209, 1, 4664);
			attr_dev(meta1, "name", "twitter:description");
			attr_dev(meta1, "content", "Cybernetically enhanced web apps");
			add_location(meta1, file, 210, 1, 4715);
			attr_dev(meta2, "name", "Description");
			attr_dev(meta2, "content", "Interactive Svelte playground");
			add_location(meta2, file, 211, 1, 4793);
			attr_dev(div, "class", "repl-outer " + (zen_mode ? 'zen-mode' : '') + " svelte-ol2svg");
			toggle_class(div, "mobile", ctx.mobile);
			add_location(div, file, 216, 0, 4917);
