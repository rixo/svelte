...
import { a as stores$1 } from './app.075f4ee4.js';
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "viewport svelte-1vmuko0");
			toggle_class(div, "offset", ctx.checked);
			add_location(div, file, 222, 2, 4990);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(meta0, file, 205, 1, 4556);
			attr_dev(meta1, "name", "twitter:description");
			attr_dev(meta1, "content", "Cybernetically enhanced web apps");
			add_location(meta1, file, 206, 1, 4607);
			attr_dev(meta2, "name", "Description");
			attr_dev(meta2, "content", "Interactive Svelte playground");
			add_location(meta2, file, 207, 1, 4685);
			attr_dev(div, "class", "repl-outer " + (zen_mode ? 'zen-mode' : '') + " svelte-1vmuko0");
			toggle_class(div, "mobile", ctx.mobile);
			add_location(div, file, 212, 0, 4809);
