...
import { a as stores$1 } from './app.2e1437f3.js';
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "viewport svelte-xvqhn6");
			toggle_class(div, "offset", ctx.checked);
			add_location(div, file, 226, 2, 5110);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(meta0, file, 209, 1, 4676);
			attr_dev(meta1, "name", "twitter:description");
			attr_dev(meta1, "content", "Cybernetically enhanced web apps");
			add_location(meta1, file, 210, 1, 4727);
			attr_dev(meta2, "name", "Description");
			attr_dev(meta2, "content", "Interactive Svelte playground");
			add_location(meta2, file, 211, 1, 4805);
			attr_dev(div, "class", "repl-outer " + (zen_mode ? 'zen-mode' : '') + " svelte-xvqhn6");
			toggle_class(div, "mobile", ctx.mobile);
			add_location(div, file, 216, 0, 4929);
